...
class TestModels(unittest.TestCase):
    ...
    def test_encdec_rnn(self):
        self.assertEqual(
            type(
                encdec_rnn(
                    optimizer='adam', loss='mean_squared_error', metrics='mean_squared_error', layer_config={
                        'layer0': (
                            100, 'relu'), 'layer1': (
                            50, 'relu'), 'layer2': (
                            50, 'relu'), 'layer3': (
                                100, 'relu')}, input_shape=(
                                    3, 3), output_shape=3, repeat=3)), TestModels.keras_obj)
